  ...
  module V1
    class AccidentsController < ApiApplicationController
      ...
      private
        ...
        def accident_params
          params.require(:accident).permit(:video_id, :lat, :long, :registration_number, witnesses_attributes: [ :name, :telephone_number, :address, :postcode ], vehicles_attributes: [ :registration_number, :driver_name, :insurance_company, :insurance_policy_number ])
        end
    end
  end
end
