...
class PaymentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_type" do
    assert_difference('PaymentType.count') do
      post payment_types_url, params: { payment_type: { description: @payment_type.description, name: @payment_type.name, payment_type_const: @payment_type.payment_type_const } }
    end
  ...
  test "should update payment_type" do
    patch payment_type_url(@payment_type), params: { payment_type: { description: @payment_type.description, name: @payment_type.name, payment_type_const: @payment_type.payment_type_const } }
